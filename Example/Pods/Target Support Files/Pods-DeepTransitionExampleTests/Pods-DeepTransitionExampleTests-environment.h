...
// DeepTransition
#define COCOAPODS_POD_AVAILABLE_DeepTransition
#define COCOAPODS_VERSION_MAJOR_DeepTransition 0
#define COCOAPODS_VERSION_MINOR_DeepTransition 1
#define COCOAPODS_VERSION_PATCH_DeepTransition 0
